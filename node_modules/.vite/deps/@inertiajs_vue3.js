  ...
  "node_modules/qs/lib/utils.js"(exports2, module2) {
      ...
      for (var i = 0; i < queue5.length; ++i) {
        ...
        for (var j = 0; j < keys2.length; ++j) {
          ...
          if (typeof val === "object" && val !== null && refs.indexOf(val) === -1) {
            queue5[queue5.length] = { obj, prop: key2 };
    ...
    var combine = function combine2(a, b, arrayLimit, plainObjects) {
      ...
      if (result2.length > arrayLimit) {
        return markOverflow(arrayToObject2(result2, { plainObjects }), result2.length - 1);
      }
      return result2;
    };
  ...
  "node_modules/qs/lib/parse.js"(exports2, module2) {
    ...
    var parseValues = function parseQueryStringValues(str, options) {
      ...
      for (i = 0; i < parts.length; ++i) {
        ...
        var val;
        if (pos === -1) {
          key2 = options.decoder(part, defaults3.decoder, charset, "key");
          val = options.strictNullHandling ? null : "";
        } else {
          key2 = options.decoder(part.slice(0, pos), defaults3.decoder, charset, "key");
          if (key2 !== null) {
            val = utils.maybeMap(
              parseArrayValue(
                part.slice(pos + 1),
                options,
                isArray3(obj[key2]) ? obj[key2].length : 0
              ),
              function(encodedVal) {
...
function create(prototype2, properties) {
  var result2 = baseCreate_default(prototype2);
...
var hasOwnProperty27 = (({ hasOwnProperty: hasOwnProperty28 }) => (obj, prop) => hasOwnProperty28.call(obj, prop))(Object.prototype);
...
function dispatchRequest(config3) {
  ...
  const adapter2 = adapters_default.getAdapter(config3.adapter || defaults_default2.adapter, config3);
...
var Config = class {
  ...
  extend(defaults3) {
    if (defaults3) {
      this.defaults = { ...this.defaults, ...defaults3 };
    }
    return this;
  }
  replace(newConfig) {
...
var History = class {
  ...
  replaceState(page22, cb = null) {
    if (isEqual_default(this.current, page22)) {
      cb && cb();
      return;
    }
...
var mergeConfig3 = (method2, url, data, config3) => ({
  url,
  method: method2,
  ...config3,
...
function useForm(...args) {
  ...
  let defaults3 = typeof data === "function" ? cloneDeep_default(data()) : cloneDeep_default(data);
  validateFormDataKeys(defaults3);
  ...
  const form = reactive({
    ...restored ? restored.data : cloneDeep_default(defaults3),
    isDirty: false,
    ...
    withPrecognition(...args2) {
      ...
      validator.on("validatingChanged", () => {
        ...
        const validationErrors = withAllErrors ?? config2.get("form.withAllErrors") ? validator.errors() : toSimpleValidationErrors(validator.errors());
        this.errors = {};
      ...
      Object.assign(formWithPrecognition, {
        ...
        validate: (field, config3) => {
          ...
          if (field === void 0) {
            ...
            validator.validate(fieldName, get_default(transformedData, fieldName), config3);
          }
          return formWithPrecognition;
        },
    ...
    data() {
      return Object.keys(defaults3).reduce((carry, key2) => {
    ...
    defaults(fieldOrFields, maybeValue) {
      ...
      if (typeof fieldOrFields === "undefined") {
        defaults3 = cloneDeep_default(this.data());
        this.isDirty = false;
      } else {
        defaults3 = typeof fieldOrFields === "string" ? set_default(cloneDeep_default(defaults3), fieldOrFields, maybeValue) : Object.assign({}, cloneDeep_default(defaults3), fieldOrFields);
      }
      validatorRef?.defaults(defaults3);
      return this;
    },
    reset(...fields) {
      const resolvedData = typeof data === "function" ? cloneDeep_default(data()) : cloneDeep_default(defaults3);
      const clonedData = cloneDeep_default(resolvedData);
      if (fields.length === 0) {
        defaults3 = clonedData;
        Object.assign(this, resolvedData);
      } else {
        ;
        fields.filter((key2) => has_default(clonedData, key2)).forEach((key2) => {
          set_default(defaults3, key2, get_default(clonedData, key2));
  ...
  watch(
    typedForm,
    (newValue) => {
      typedForm.isDirty = !isEqual_default(typedForm.data(), defaults3);
      const storedData = router.restore(rememberKey);
      const newData = cloneDeep_default(newValue.__remember());
      if (rememberKey && !isEqual_default(storedData, newData)) {
...
function useRemember(data, key2) {
  ...
  const remembered = type(
    restored === void 0 ? data : hasCallbacks ? data.__restore(cloneDeep_default(restored)) : cloneDeep_default(restored)
  );
  watch(
    remembered,
    (newValue) => {
